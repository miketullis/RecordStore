...
using System.IO;//added for FileInfo (IO =  Input/Output)




namespace RecordStore.UI.MVC.Utilities
{
    public class ImageUtility
    {
        ...
        public static Bitmap DoResizeImage(int imgWidth, int imgHeight, Image image)
        {
            ...
            newImage.MakeTransparent(); // Set image to screen resolution of 72 dpi
        ...
        public static void Delete(string path, string fileName)
        {
            ...
            //Create FileInfo objects for both versions of the file
            ...
            //Check for existing thumbnail and delete it.
            if (thumbImg.Exists)
            {
                thumbImg.Delete();
            }
